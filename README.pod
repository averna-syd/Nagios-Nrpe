...
Nagios::Nrpe - Small framework for creating and using custom NAGIOS NRPE
checks.
...
open ( my $fh, '-|', '/usr/bin/yum check-update' ) || $nrpe->error('yum
failed');
...
my $nrpe = Nagios::Nrpe->new();
$nrpe->exit_ok( 'oh god, oh god, we're all going to die',
'stat1=123;stat2=321;' );
